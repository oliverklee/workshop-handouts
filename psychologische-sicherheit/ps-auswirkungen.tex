...
\begin{itemize}
  ...
  \item ob die Führung überhaupt von Problemen erfährt (das ist der Aspekt, bei dem die Führung am wenigsten mitbekommt, wenn es dem Team an psychologischer Sicherheit mangelt) \index{Probleme} oder in einer Illusion von Erfolg lebt
  ...
  \item ob sich Diversität positiv oder negativ auf den Teamerfolg auswirkt \index{Diversität}
\end{itemize}
